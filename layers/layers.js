...
var format_Box_Alva_Valve_8 = new ol.format.GeoJSON();
var features_Box_Alva_Valve_8 = format_Box_Alva_Valve_8.readFeatures(json_Box_Alva_Valve_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Box_Alva_Valve_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Box_Alva_Valve_8.addFeatures(features_Box_Alva_Valve_8);
var lyr_Box_Alva_Valve_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Box_Alva_Valve_8, 
                style: style_Box_Alva_Valve_8,
                popuplayertitle: 'Box_Alva_Valve',
                interactive: true,
                title: '<img src="styles/legend/Box_Alva_Valve_8.png" /> Box_Alva_Valve'
            });
var format_Box_Gate_Valve_9 = new ol.format.GeoJSON();
var features_Box_Gate_Valve_9 = format_Box_Gate_Valve_9.readFeatures(json_Box_Gate_Valve_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Box_Gate_Valve_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Box_Gate_Valve_9.addFeatures(features_Box_Gate_Valve_9);
var lyr_Box_Gate_Valve_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Box_Gate_Valve_9, 
                style: style_Box_Gate_Valve_9,
                popuplayertitle: 'Box_Gate_Valve',
                interactive: true,
                title: '<img src="styles/legend/Box_Gate_Valve_9.png" /> Box_Gate_Valve'
            });
...
var group_TITIKAKSESSORIS = new ol.layer.Group({
                                layers: [lyr_Box_Alva_Valve_8,lyr_Box_Gate_Valve_9,lyr_Rumah_Pompa_10,],
                                fold: 'open',
...
lyr_GoogleSatellite_0.setVisible(true);lyr_SUNGAI_1.setVisible(true);lyr_JALAN_2.setVisible(true);lyr_LUAS_FUNGSIONAL_3.setVisible(true);lyr_KETERANGAN_KERUSAKAN_SALURAN_4.setVisible(true);lyr_JENIS_SALURAN_5.setVisible(true);lyr_Tikungan_6.setVisible(true);lyr_Titik_Per50_m_7.setVisible(true);lyr_Box_Alva_Valve_8.setVisible(true);lyr_Box_Gate_Valve_9.setVisible(true);lyr_Rumah_Pompa_10.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_SUNGAI_1,lyr_JALAN_2,lyr_LUAS_FUNGSIONAL_3,lyr_KETERANGAN_KERUSAKAN_SALURAN_4,lyr_JENIS_SALURAN_5,group_TITIKKETERANGAN,group_TITIKAKSESSORIS];
...
lyr_Tikungan_6.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Id': 'Id', 'NAMA': 'NAMA', 'ALAMAT': 'ALAMAT', 'X': 'X', 'Y': 'Y', 'BUJUR': 'BUJUR', 'LINTANG': 'LINTANG', 'PANJANG': 'PANJANG', 'FOTO1': 'FOTO1', 'FOTO2': 'FOTO2', 'FOTO3': 'FOTO3', 'FOTO4': 'FOTO4', 'FOTO5': 'FOTO5', 'FOTO6': 'FOTO6', 'FOTO7': 'FOTO7', 'FOTO8': 'FOTO8', });
lyr_Titik_Per50_m_7.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Id': 'Id', 'NAMA': 'NAMA', 'ALAMAT': 'ALAMAT', 'X': 'X', 'Y': 'Y', 'BUJUR': 'BUJUR', 'LINTANG': 'LINTANG', 'PANJANG': 'PANJANG', 'FOTO1': 'FOTO1', 'FOTO2': 'FOTO2', 'FOTO3': 'FOTO3', 'FOTO4': 'FOTO4', 'FOTO5': 'FOTO5', 'FOTO6': 'FOTO6', 'FOTO7': 'FOTO7', 'FOTO8': 'FOTO8', });
lyr_Box_Alva_Valve_8.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Id': 'Id', 'NAMA': 'NAMA', 'ALAMAT': 'ALAMAT', 'X': 'X', 'Y': 'Y', 'BUJUR': 'BUJUR', 'LINTANG': 'LINTANG', 'PANJANG': 'PANJANG', 'FOTO1': 'FOTO1', 'FOTO2': 'FOTO2', 'FOTO3': 'FOTO3', 'FOTO4': 'FOTO4', 'FOTO5': 'FOTO5', 'FOTO6': 'FOTO6', 'FOTO7': 'FOTO7', 'FOTO8': 'FOTO8', });
lyr_Box_Gate_Valve_9.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Id': 'Id', 'NAMA': 'NAMA', 'ALAMAT': 'ALAMAT', 'X': 'X', 'Y': 'Y', 'BUJUR': 'BUJUR', 'LINTANG': 'LINTANG', 'PANJANG': 'PANJANG', 'FOTO1': 'FOTO1', 'FOTO2': 'FOTO2', 'FOTO3': 'FOTO3', 'FOTO4': 'FOTO4', 'FOTO5': 'FOTO5', 'FOTO6': 'FOTO6', 'FOTO7': 'FOTO7', 'FOTO8': 'FOTO8', });
lyr_Rumah_Pompa_10.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Id': 'Id', 'NAMA': 'NAMA', 'ALAMAT': 'ALAMAT', 'X': 'X', 'Y': 'Y', 'BUJUR': 'BUJUR', 'LINTANG': 'LINTANG', 'PANJANG': 'PANJANG', 'FOTO1': 'FOTO1', 'FOTO2': 'FOTO2', 'FOTO3': 'FOTO3', 'FOTO4': 'FOTO4', 'FOTO5': 'FOTO5', 'FOTO6': 'FOTO6', 'FOTO7': 'FOTO7', 'FOTO8': 'FOTO8', });
...
lyr_Tikungan_6.set('fieldImages', {'OBJECTID': 'TextEdit', 'Id': 'TextEdit', 'NAMA': 'TextEdit', 'ALAMAT': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'BUJUR': 'TextEdit', 'LINTANG': 'TextEdit', 'PANJANG': 'TextEdit', 'FOTO1': 'ExternalResource', 'FOTO2': 'ExternalResource', 'FOTO3': 'ExternalResource', 'FOTO4': 'ExternalResource', 'FOTO5': 'ExternalResource', 'FOTO6': 'ExternalResource', 'FOTO7': 'ExternalResource', 'FOTO8': 'ExternalResource', });
lyr_Titik_Per50_m_7.set('fieldImages', {'OBJECTID': 'TextEdit', 'Id': 'TextEdit', 'NAMA': 'TextEdit', 'ALAMAT': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'BUJUR': 'TextEdit', 'LINTANG': 'TextEdit', 'PANJANG': 'TextEdit', 'FOTO1': 'ExternalResource', 'FOTO2': 'ExternalResource', 'FOTO3': 'ExternalResource', 'FOTO4': 'ExternalResource', 'FOTO5': 'ExternalResource', 'FOTO6': 'ExternalResource', 'FOTO7': 'ExternalResource', 'FOTO8': 'ExternalResource', });
lyr_Box_Alva_Valve_8.set('fieldImages', {'OBJECTID': 'TextEdit', 'Id': 'TextEdit', 'NAMA': 'TextEdit', 'ALAMAT': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'BUJUR': 'TextEdit', 'LINTANG': 'TextEdit', 'PANJANG': 'TextEdit', 'FOTO1': 'ExternalResource', 'FOTO2': 'ExternalResource', 'FOTO3': 'ExternalResource', 'FOTO4': 'ExternalResource', 'FOTO5': 'ExternalResource', 'FOTO6': 'ExternalResource', 'FOTO7': 'ExternalResource', 'FOTO8': 'ExternalResource', });
lyr_Box_Gate_Valve_9.set('fieldImages', {'OBJECTID': 'TextEdit', 'Id': 'TextEdit', 'NAMA': 'TextEdit', 'ALAMAT': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'BUJUR': 'TextEdit', 'LINTANG': 'TextEdit', 'PANJANG': 'TextEdit', 'FOTO1': 'ExternalResource', 'FOTO2': 'ExternalResource', 'FOTO3': 'ExternalResource', 'FOTO4': 'ExternalResource', 'FOTO5': 'ExternalResource', 'FOTO6': 'ExternalResource', 'FOTO7': 'ExternalResource', 'FOTO8': 'ExternalResource', });
lyr_Rumah_Pompa_10.set('fieldImages', {'OBJECTID': 'TextEdit', 'Id': 'TextEdit', 'NAMA': 'TextEdit', 'ALAMAT': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'BUJUR': 'TextEdit', 'LINTANG': 'TextEdit', 'PANJANG': 'TextEdit', 'FOTO1': 'ExternalResource', 'FOTO2': 'ExternalResource', 'FOTO3': 'ExternalResource', 'FOTO4': 'ExternalResource', 'FOTO5': 'ExternalResource', 'FOTO6': 'ExternalResource', 'FOTO7': 'ExternalResource', 'FOTO8': 'ExternalResource', });
...
lyr_Tikungan_6.set('fieldLabels', {'OBJECTID': 'hidden field', 'Id': 'hidden field', 'NAMA': 'inline label - visible with data', 'ALAMAT': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - visible with data', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', 'FOTO1': 'no label', 'FOTO2': 'no label', 'FOTO3': 'no label', 'FOTO4': 'no label', 'FOTO5': 'no label', 'FOTO6': 'no label', 'FOTO7': 'no label', 'FOTO8': 'no label', });
lyr_Titik_Per50_m_7.set('fieldLabels', {'OBJECTID': 'hidden field', 'Id': 'hidden field', 'NAMA': 'inline label - visible with data', 'ALAMAT': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - visible with data', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', 'FOTO1': 'no label', 'FOTO2': 'no label', 'FOTO3': 'no label', 'FOTO4': 'no label', 'FOTO5': 'no label', 'FOTO6': 'no label', 'FOTO7': 'no label', 'FOTO8': 'no label', });
...
lyr_Box_Gate_Valve_9.set('fieldLabels', {'OBJECTID': 'hidden field', 'Id': 'hidden field', 'NAMA': 'inline label - visible with data', 'ALAMAT': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - visible with data', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', 'FOTO1': 'no label', 'FOTO2': 'no label', 'FOTO3': 'no label', 'FOTO4': 'no label', 'FOTO5': 'no label', 'FOTO6': 'no label', 'FOTO7': 'no label', 'FOTO8': 'no label', });
lyr_Rumah_Pompa_10.set('fieldLabels', {'OBJECTID': 'hidden field', 'Id': 'hidden field', 'NAMA': 'inline label - visible with data', 'ALAMAT': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - visible with data', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', 'FOTO1': 'no label', 'FOTO2': 'no label', 'FOTO3': 'no label', 'FOTO4': 'no label', 'FOTO5': 'no label', 'FOTO6': 'no label', 'FOTO7': 'no label', 'FOTO8': 'no label', });
lyr_Rumah_Pompa_10.on('precompose', function(evt) {

...
function exp_label_BANGUNAN_NOMENKLATUR_11_eval_expression(context) {
    // NAMA + ' ' + URUTAN + ' ' + PEMBAGIAN

    var feature = context.feature;
    
    if (feature.properties) {
        return ((((feature.get('NAMA')  + ' ') + feature.get('URUTAN') ) + ' ') + feature.get('PEMBAGIAN') );
    } else {
        return ((((feature.get('NAMA')  + ' ') + feature.get('URUTAN') ) + ' ') + feature.get('PEMBAGIAN') );
    }
}